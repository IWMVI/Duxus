...
public class ProcessamentoService {
    ...
    public TimeDaDataResponse timeDaData(LocalDate data) {
        ...
        return time == null ? null : new TimeDaDataResponse(time);
    }

    public IntegranteResponse integranteMaisUsado(LocalDate dataInicial, LocalDate dataFinal) {
        Integrante integrante = apiService.integranteMaisUsado(dataInicial, dataFinal, todosOsTimes());
        return integrante == null ? null : new IntegranteResponse(integrante);
    }
